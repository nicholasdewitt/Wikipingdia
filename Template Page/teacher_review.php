<?php
$namequery = "SELECT teacher_fname FROM teacher WHERE teacher_fname = 'Rebecca'";
$conn = new mysqli('localhost', 'root', '', 'RecordsDB');
         ...
         <div id="main">
            ...
            <div class="inner">
               ...
               <section id="banner" style="padding: 0em 0em 0em 0em ; width: auto; border: 0px solid black">
                  ...
                  <a href="index.html" class="logo" align='center'>Education</a>&ensp;&ensp;
                  <a href="index.html" class="logo" align='center'>Current Classes</a>&ensp;&ensp;
                  <a href="index.html" class="logo" align='center'>Research/Job Opportunities</a>&ensp;&ensp;
                  <a href="index.html" class="logo" align='center'>Contact</a>
               </h4></div>
               </section>
               <header>
                  <div class="content">
                        <h2>Dr. Strange Reviews
                        ...
                        <p style="text-indent :3em;">Reviews table goes here</p>
                        <h3>&nbsp;   </h3>
                        <div>
                        <a href="https://ischool.umd.edu/calendar"><h4 align="center">Write a Review</h4></a>
                        </div>
                  </div>
               </header>
            </div>
